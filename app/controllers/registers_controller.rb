...
class RegistersController < ApplicationController
  ...
  def index
    ...
    @registers = @search.result.where(register_phase: 'Beta').sort_by_phase_name_asc.by_name if params[:phase] == 'ready to use'
    @registers = @search.result.where.not(register_phase: 'Beta').sort_by_phase_name_asc.by_name if params[:phase] == 'in progress'
